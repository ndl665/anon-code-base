    ...
    with open(filename) as f:
        for line in f:
            ...
            for i in range(len(js)):
                # print(js[i])
                example = InputExample(guid=js[i]['target'], text_a=js[i]['func'], text_b=js[i]['diff'])
...
train_dataset = read_answers('../../../dataset/1204sdiff/train_set.json')
valid_dataset = read_answers('../../../dataset/1204sdiff/val_set.json')
test_dataset = read_answers('../../../dataset/1204sdiff/test_set.json')
...
print('!!!!!{"soft"} The modified code is {"soft"} {"placeholder":"text_a"}. {"soft"}The introduced diff is {"soft"}{"placeholder":"text_b"}. {"soft"} The commit is {"mask"}.')
promptTemplate = MixedTemplate(
    model=plm,
    text='{"soft"} The modified code is {"soft"} {"placeholder":"text_a"}. {"soft"}The introduced diff is {"soft"}{"placeholder":"text_b"}. {"soft"} The commit is {"mask"}.',
    tokenizer=tokenizer,
)
