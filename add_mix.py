...
print('!!!!!{"soft"}Added lines: {"soft"}[ADD] {"placeholder":"text_a"}.{"soft"}Deleted lines: [DEL]  {"placeholder":"text_b"}{"soft"}. The commit is {"mask"}.')
promptTemplate = MixedTemplate(
    model=plm,
    text='{"soft"}Added lines: {"soft"}[ADD] {"placeholder":"text_a"}.{"soft"}Deleted lines: [DEL]  {"placeholder":"text_b"}{"soft"}. The commit is {"mask"}.',
    tokenizer=tokenizer,
)
