...
print('!!!!!The modified code is {"placeholder":"text_a"}.The introduced diff is  {"placeholder":"text_b"}. The commit is {"mask"}.')
promptTemplate = MixedTemplate(
    model=plm,
    text='The modified code is {"placeholder":"text_a"}.The introduced diff is  {"placeholder":"text_b"}. The commit is {"mask"}.',
    tokenizer=tokenizer,
)
