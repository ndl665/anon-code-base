    ...
    with open(filename) as f:
        for line in f:
            ...
            for i in range(len(js)):
                # print(js[i])
                example = InputExample(guid=js[i]['target'], text_a=js[i]['func'])
...
train_dataset = read_answers('../../../dataset/1204diff/train_set.json')
valid_dataset = read_answers('../../../dataset/1204diff/val_set.json')
test_dataset = read_answers('../../../dataset/1204diff/test_set.json')
...
print('!!!!!{"soft"} The code is {"soft"} {"placeholder":"text_a"} {"soft"} . It is {"mask"}.')
promptTemplate = MixedTemplate(
    model=plm,
    text='{"soft"} The code is {"soft"} {"placeholder":"text_a"} {"soft"} . It is {"mask"}.',
    tokenizer=tokenizer,
)
